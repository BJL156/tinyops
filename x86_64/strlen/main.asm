section .data
  msg: db "This is 27 characters long.", 0x0 ; `0x0` is a null terminator (Typically represented in high level langauges as: '\0').
...
_start:
  ...
  ; exit program
  mov rax, 60
  mov rdi, rbx ; exit code is now the result of the `strlen` function.
  syscall
